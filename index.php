...
<body style="margin: 0 auto;width:90%;padding:10px;">
	<h2>Tes Analisis Sentimen</h2>
    <form class="pure-form" style="width:100%" action="" method="post">
    
        <fieldset class="pure-group">
            <textarea name="kalimat" class="pure-input-1-2" placeholder="kalimat (contoh: Bapak Budi sangat rajin sekali pergi ke kantor tiap pagi.)"></textarea>
        </fieldset>
